    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "serial_number",
                    models.TextField(unique=True, verbose_name="Зав. № машины"),
                ),
                (
                    "engine_serial_number",
                    models.TextField(verbose_name="Зав. № двигателя"),
                ),
                (
                    "transmission_serial_number",
                    models.TextField(verbose_name="Зав. № трансмиссии"),
                ),
                (
                    "driving_axle_serial_number",
                    models.TextField(verbose_name="Зав. № ведущего моста"),
                ),
                (
                    "steering_axle_serial_number",
                    models.TextField(verbose_name="Зав. № управляемого моста"),
                ),
                (
                    "shipment_date",
                    models.DateField(verbose_name="Дата отгрузки с завода"),
                ),
                (
                    "consignee",
                    models.TextField(
                ...
                (
                    "delivery_adress",
                    models.TextField(verbose_name="Адрес поставки (эксплуатации)"),
                ),
                (
                    "additional_equipment",
                    models.TextField(verbose_name="Комплектация (доп. опции)"),
                ),
            ],
            options={
                "verbose_name": "Машина",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Модель техники", "Car Model"),
                            ("Двигатель", "Eninge Model"),
                            ("Трансмиссия", "Transmission Model"),
                            ("Ведущий мост", "Driving Axle Model"),
                            ("Управляемый мост", "Steering Axle Model"),
                            ("Тип ТО", "Maitenance Type"),
                            ("Компания", "Maitenance Provider"),
                            ("Способ восстановления", "Repair Method"),
                            ("Узел отказа", "Repair Unit"),
                        ],
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operating_time",
                    models.IntegerField(verbose_name="Наработка, м/час"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(unique=True, verbose_name="№ заказ-наряда"),
                ),
                ("contract_date", models.DateField(verbose_name="Дата заказ-наряда")),
                (
                    "self_maitenance",
                    models.BooleanField(
                        default=False, verbose_name="Самостоятельное проведение ТО"
                    ),
                ),
                (
                    "car",
