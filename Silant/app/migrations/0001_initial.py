    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.client', verbose_name='Покупатель')),
                ('driving_axle_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.drivingaxlemodel', verbose_name='Модель ведущего моста')),
                ('engine_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.enginemodel', verbose_name='Модель двигателя')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.carmodel', verbose_name='Модель техники')),
                ('service_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.servicecompany', verbose_name='Сервисная компания')),
                ('steering_axle_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.steeringaxlemodel', verbose_name='Модель управляемого моста')),
                ('transmission_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.transmissionmodel', verbose_name='Модель трансмиссии')),
            ],
            options={
                'verbose_name': 'Машина',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.servicecompany', verbose_name='Сервисная компания')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='manuals.repairunit', verbose_name='Узел отказа')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.maitenanceprovider', verbose_name='Организация, проводившая ТО')),
                ('service_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='maitenance_service_company', to='users.servicecompany', verbose_name='Сервисная компания')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manuals.maitenancetype', verbose_name='Вид ТО')),
            ],
            options={
                'verbose_name': 'ТО',
